...
def ipa_pinyin(ipa):
    ...
    elif ipa.endswith('i')     and not(ipa.endswith('ai') or ipa.endswith('ei')): vowel = 'i'
    ...
    elif ipa.endswith('ei') and not(ipa.endswith('uei') or ipa.endswith('yei')): vowel = 'ei'
    elif ipa.endswith('uei'): vowel = 'uei'
    elif ipa.endswith('yei'): vowel = 'yuei'
    elif (ipa.endswith('au') or ipa.endswith('ɐɔ') or ipa.endswith('ɑʊ')) and not(ipa.endswith('iau') or ipa.endswith('iɐɔ') or ipa.endswith('iɑʊ')): vowel = 'ao'
    elif ipa.endswith('iau') or ipa.endswith('iɐɔ') or ipa.endswith('iɑʊ'): vowel = 'iao'
